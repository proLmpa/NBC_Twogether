...
function kakao_login() {
    var redirectUri = encodeURIComponent(
        BASE_URL + '/api/social/kakao/callback');
...
function naver_login() {
    var redirectUri = encodeURIComponent(
        BASE_URL + '/api/social/naver/callback');
    var clientId = 'z4SZ2cx6filEURbIUuq6';

    return 'https://nid.naver.com/oauth2.0/authorize?client_id=' + clientId
        + '&redirect_uri=' + redirectUri + '&state=test&response_type=code';
}
